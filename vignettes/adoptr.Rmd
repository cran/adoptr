...
[composite scores](https://optad.github.io/adoptr/articles/composite-scores.html).
...
(cf. [conditional scores](https://optad.github.io/adoptr/articles/conditional-scores.html)).

* Arbitrary continuous or discrete 
[prior distributions](https://optad.github.io/adoptr/articles/working-with-priors.html) 
...
sums etc. (cf. [composite scores](https://optad.github.io/adoptr/articles/composite-scores.html)).

* Relatively flexible framework for
[defining new scores](https://optad.github.io/adoptr/articles/defining-new-scores.html).
